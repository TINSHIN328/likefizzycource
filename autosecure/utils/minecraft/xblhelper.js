...
async function xblhelper(axios) {
    for (let attempt = 1; attempt <= 3; attempt++) {
        ...
        try {
            const loginRedirect = await axios.get(`https://sisu.xboxlive.com/connect/XboxLive/?state=login&cobrandId=8058f65d-ce06-4c30-9559-473c9275a65d&tid=896928775&ru=https://www.minecraft.net/en-us/login&aid=1276276335`);
